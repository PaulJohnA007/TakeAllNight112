<?
    ...
    $(document).ready(function() {
        ...
        function fetchAttendancePeriodically() {
            ...
            setInterval(fetchAttendanceData, 5000); // Fetch every 5 seconds (adjust as needed)
        }
        ...
        function populateAttendanceTable(data) {
            // Update the attendance table with the received data
            // You can use similar logic as in your existing code
        }
